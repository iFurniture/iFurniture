...
WYMeditor.editor.prototype.dialog = function( dialogType ) {
  ...
  switch(dialogType) {
    ...
    case WYMeditor.DIALOG_PASTE:
      ...
      break;
    default:
      $("<img id='dialog_loading' src='/assets/refinery/dialogLoadingAnimation-1da817fd12a97dcdd18f98984dd1fc44dc490890e146bbda2a34c3c51d1da58a.gif' width='208' height='13' />").appendTo(dialog_container);
...
// supply custom_visual_editor_boot_options if you want to override anything here.
...
var wymeditor_boot_options = $.extend({
  skin: 'refinery'
  , basePath: "/"
  , wymPath: "/assets/refinery/wymeditor.js"
  ...
  , dialogTableHtml:
    "<div class='visual_editor_dialog visual_editor_dialog_table'>"
      + "<form>"
        + "<input type='hidden' id='visual_editor_dialog_type' class='visual_editor_dialog_type' value='"+ WYMeditor.DIALOG_TABLE + "' />"
        + "<div class='field'>"
  ...
  , dialogPasteHtml:
    "<div class='visual_editor_dialog visual_editor_dialog_paste'>"
      + "<form>"
        + "<input type='hidden' id='visual_editor_dialog_type' class='visual_editor_dialog_type' value='" + WYMeditor.DIALOG_PASTE + "' />"
        + "<div class='field'>"
          + "<textarea class='wym_text' rows='10' cols='50'></textarea>"
        + "</div>"
        + form_actions
  ...
  , postInit: function(wym)
  {
    ...
    $(wym._iframe).contents().find('body').addClass('visual_editor_iframe_body');
...
WYMeditor.init = function() {
  wymeditor_inputs = $('.wymeditor, .visual_editor').filter(function(index) {
